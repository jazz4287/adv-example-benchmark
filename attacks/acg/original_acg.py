...
import numpy as np
import torch
from attacks.acg.utils.step_size import update_step_size
from attacks.acg.utils.common import Clamp

from attacks.acg.Attacker import RestartAttacker
...
class AUTOConjugate(RestartAttacker):
    ...
    def __init__(self, *args, **kwargs):
        ...
        assert self.epsilon >= 0, f"Value of epsilon must be positive, but got {self.epsilon}."
        self.name = "AUTOConjugate"
        self.gather.setParam("epsilon", self.epsilon)
